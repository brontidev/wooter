...
To create a Middleware, you can use the `.use` method on the Wooter instance. Middleware functions are passed a new
...
$:import { None, Option } from '@bronti/wooter/option'
