...
import { Data, Params } from "./export/types.ts"
...
function someFunctionWithACallback(data: string, callback: (data: string, dataAgain: string) => void) {
...
ctx[RouteContext__respond].then(v => console.log("respond event: ", v.toString()))
